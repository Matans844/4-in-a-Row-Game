...
namespace GameLogic
{
	public class PlayerHuman : Player
	{
		...
		public override void MakeMove(int i_ChosenBoardColumnAjustedForMatrix)
		{
			this.BoardOfPlayer.SlideDiskToBoard(i_ChosenBoardColumnAjustedForMatrix, this.DiscType);
